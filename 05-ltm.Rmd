...
```{r morris, echo = FALSE, out.width='70%', fig.align = 'center', fig.cap = 'Results from Morris and colleagues’ Transfer-Appropriate Processing experiment [@Morris1977, Experiment 1].'}
