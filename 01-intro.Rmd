...
```{r scatter, echo = FALSE, out.width='80%', fig.align = 'center', fig.cap='Scatterplot of the association between working memory and reading comprehension, a positive correlation. Each dot represents an individual. Simulated data for illustration purposes.'}
y <- c(2,2,3,4,3,4,5,5)
x <- c(2,3,3,3,4,4,4,5)
plot(x, y, type = "p", xlab = "Working memory capacity", ylab = "Reading comprehension", ylim = c(1.5,5.5), xlim = c(1.5,5.5), pch = 19, col = "#117EA7")
...
```{r scatter2, echo = FALSE, out.width='80%', fig.align = 'center', fig.cap='Scatterplot showing the negative relationship between caffeine consumption and reaction time (*r* = –.5). Each dot represents a participant. Simulated data for illustration purposes.'}
x <- c(0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 30, 80, 120, 160, 200, 240, 280, 320, 360, 40, 90, 140, 190, 240, 290, 340)
y <- c(340, 330, 325, 310, 295, 280, 265, 250, 330, 290, 245, 300, 240, 320, 310, 285, 360, 315, 290, 275, 350, 265, 250, 290, 270, 345, 300, 270, 285, 280, 265, 305)

plot(x, y, type = "p", xlab = "Caffeine consumption (mg)", ylab = "Reaction time (ms)", 
     ylim = c(150, 390), xlim = c(0, 400), pch = 19, col = "#117EA7")
grid(nx = NULL, ny = NULL,
     lty = 2,      # Grid line type
     col = "#7F7F7F40", # Grid line color
     lwd = 1)      # Grid line width
