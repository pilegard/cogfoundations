...
```{r kanzi, echo = FALSE, out.width='25%', fig.show='hold', fig.align = 'center', fig.cap = '[Watch: “Kanzi and Novel Sentences” on YouTube](http://www.youtube.com/watch?v=2Dhc2zePJFE); Image: [Wikimedia Commons](https://upload.wikimedia.org/wikipedia/commons/2/29/Bonobo_Kanzi_postshower_2005-07-23_GATI_330crop_%282014_11_14_01_04_18_UTC%29.jpg)'}
knitr::include_graphics(c("images/ch8/qr.png","images/ch8/kanzi.jpeg"))
```
...
```{r model, echo = FALSE, out.width='80%', fig.align = 'center', fig.cap = 'A model of communication with language exchanges to help them practice language.'}
...
```{r speechsounds, echo = FALSE, out.width='50%', fig.align = 'center', fig.cap = 'Watch [Tuning Into Speech Sounds](https://www.youtube.com/watch?v=WvM5bqUsbu8) on YouTube'}
...
```{r practicing, echo = FALSE, out.width='40%', fig.align = 'center', fig.cap = 'Babies often engage in vocal exchanges to help them practice language.'}
...
```{r languagelearning, echo = FALSE, out.width='90%', fig.align = 'center', fig.cap = 'English Proficiency in Native Chinese Speakers. Hakuta et al. found no evidence for critical periods in language learning. Regardless of level of education, self-reported second-language skills decreased consistently across age of immigration.'}
