...
```{r fig9.7, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Figure 7. Relation between (monetary) gains/losses and their subjective value according to Prospect Theory.'}
