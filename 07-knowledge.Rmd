...
```{r network, echo = FALSE, out.width='50%', fig.align = 'center', fig.cap = 'Semantic Network according to Collins and Quillian with nodes, links, concept names and properties. '}
...
```{r pyramid, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Some of the major tools of theory of mind, with the bottom showing simple, automatic, early developing processes, and the top showing complex, more deliberate, late developing processes. '}
