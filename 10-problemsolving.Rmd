...
```{r creature, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = '@smith1993constraining showed their participants examples similar to these. *Drawings by Michael Barlev and Annie Ditta.*'}
