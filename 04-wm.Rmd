...
```{r fig1, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Figure 1. Atkinson and Shiffrin’s Modal Model of Memory. Image from Wikimedia Commons.'}
#knitr::include_graphics("images/ch4/fig1.jpg")
```
