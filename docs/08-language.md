...
<img src="images/ch8/kanzi.jpeg" alt="Sue Savage-Rumbaugh (L), Kanzi (R), and his sister Panbinisha (C) working together in 2006. To see Kanzi in action, watch [“Kanzi and Novel Sentences” on YouTube](http://www.youtube.com/watch?v=2Dhc2zePJFE). Image by William H. Calvin, CC BY-SA 4.0" width="75%" />
<p class="caption">(\#fig:kanzi)Sue Savage-Rumbaugh (L), Kanzi (R), and his sister Panbinisha (C) working together in 2006. To see Kanzi in action, watch [“Kanzi and Novel Sentences” on YouTube](http://www.youtube.com/watch?v=2Dhc2zePJFE). Image by William H. Calvin, CC BY-SA 4.0</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/ch8/fig3.png" alt="English Proficiency in Native Chinese Speakers. Hakuta et al. found no evidence for critical periods in language learning. Regardless of level of education, self-reported second-language skills decreased consistently across age of immigration." width="90%" />
