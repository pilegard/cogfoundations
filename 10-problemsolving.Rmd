# Problem Solving
```{r fig10.0, echo = FALSE, out.width='100%', fig.align = 'center', fig.alt = 'A man stands on an oversized outdoor chess board in a park, looking pensively down at chess pieces.'}
...
```{r chain1, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'The materials for the cheap necklace problem.', fig.alt = 'Four separate pieces of chain, each made of three links, in four different colors: red, yellow, blue, and green.'}
...
```{r candle1, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'The materials for the candle problem.', fig.alt = 'An illustration of the materials for the candle problem: a box filled with tacks, a candle lying on its side, and a book of matches.'}
...
```{r candle2, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'The same materials, presented slightly differently.', fig.alt = 'The same materials as the candle problem, but now the box is empty and the tacks are arranged outside of it, making the box available as a separate object.'}
...
```{r candle3, echo = FALSE, out.width='45%', fig.align = 'center', fig.cap = 'A solution to the candle problem.', fig.alt = 'The solution to the candle problem: the empty box has been tacked to the wall, the candle stands upright and lit inside the box serving as a platform, and the matchbook and remaining tacks rest on the ground below.'}
...
```{r twostring, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'The two-string problem.', fig.alt = 'Illustration of the two-string problem. A person holds one of two strings hanging from the ceiling; the second string hangs out of reach. A chair and a pair of pliers rest on the ground nearby.'}
...
```{r twostring2, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'A solution to the two-string problem.', fig.alt = 'The solution to the two-string problem: the person has tied the pliers to the second string and set it swinging like a pendulum, then walked to grab it as it swung within reach.'}
knitr::include_graphics("images/ch10/twostring2.png")
```

```{r chain2, echo = FALSE, out.width='50%', fig.align = 'center', fig.cap = 'The solution to the cheap necklace problem.', fig.alt = 'The solution to the chain problem: three lengths of chain in blue, yellow, and green are connected into a single loop using the individual links from the red chain.'}
...
```{r creature, echo = FALSE, out.width='85%', fig.align = 'center', fig.cap = '@smith1993constraining showed their participants examples similar to these. *Drawings by Michael Barlev and Annie Ditta.*', fig.alt = 'Front and side view illustrations of two fictional creatures. The top creature has a long thin body and a head resembling a praying mantis, with labeled antennae, eyes, nose, tail, and legs. The bottom creature has a round head and body with clawed legs and barbed antennae and tail, with the same features labeled.'}
...
```{r ninedot, echo = FALSE, out.width='40%', fig.align = 'center', fig.cap = 'The nine-dot problem.', fig.alt = 'Nine dots arranged in a 3 by 3 grid with equal spacing, used to illustrate the nine-dot problem.'}
...
```{r ninedotsolution, echo = FALSE, out.width='40%', fig.align = 'center', fig.cap = 'Solutions to the nine-dot problem.', fig.alt = 'Two solutions to the nine-dot problem, both requiring lines to extend beyond the boundaries of the grid. The top solution uses four straight lines that connect all nine dots by extending outside the grid at two corners. The bottom solution uses three lines in a wide, shallow zigzag pattern that passes through all nine dots by extending well beyond the grid on both sides.'}
