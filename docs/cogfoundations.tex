...
\caption{Scatterplot of the association between working memory and reading comprehension, a positive correlation. Each dot represents an individual. Simulated data for illustration purposes.}\label{fig:scatter}
\end{figure}
...
\caption{Scatterplot showing the negative relationship between caffeine consumption and reaction time (*r* = –.5). Each dot represents a participant. Simulated data for illustration purposes.}\label{fig:scatter2}
\end{figure}
