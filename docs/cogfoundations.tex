...
The HTML version of \emph{Cognitive Foundations} is built to conform with the \href{https://www.w3.org/TR/2025/REC-WCAG21-20250506/}{Web Content Accessibility Guidelines (WCAG) 2.1} at Level AA, including alt text, keyboard navigability, and heading structure. If you encounter a barrier or have a suggestion for improvement, please use our \href{https://forms.gle/83CBvAgLuJshRfz37}{feedback form} or open an issue on \href{https://github.com/pilegard/cogfoundations}{GitHub}.

The PDF version does not support alt text or other accessibility features. To access the HTML version, visit \href{https://pilegard.github.io/cogfoundations/}{pilegard.github.io/cogfoundations/}.
...
\bottomrule\noalign{}
\endlastfoot
Position & We tend to see objects higher up in our field of vision as farther away. & The fence posts at right appear farther away not only because they become smaller but also because they appear higher up in the picture. & \pandocbounded{\includegraphics[keepaspectratio,alt={A photograph of fence posts receding into the distance, appearing smaller and higher in the frame as they get farther away.}]{images/ch2/depth1.jpg}} \\
Relative size & Assuming that the objects in a scene are the same size, smaller objects are perceived as father away. & at right, the cars in the distance appear smaller than those nearer to us. & \pandocbounded{\includegraphics[keepaspectratio,alt={A photograph of a road with cars; vehicles in the foreground appear larger than those farther away.}]{images/ch2/depth2.jpg}} \\
Linear perspective & Parallel lines appear to converge at a distance. & We know that the tracks at right are parallel. When they appear closer together, we determine they are farther away. & \pandocbounded{\includegraphics[keepaspectratio,alt={A photograph of railroad tracks converging toward a vanishing point in the distance.}]{images/ch2/depth3.jpg}} \\
Light and shadow & The eye receives more reflected light from objects that are closer to us. Normally, light comes from above, so darker images are in shadow. & We see the images at right as extending and indented according to their shadowing. If we invert the picture, the images will reverse. & \pandocbounded{\includegraphics[keepaspectratio,alt={A pattern of circular shapes that appear to protrude or indent depending on the direction of shading, demonstrating how light and shadow create a sense of depth.}]{images/ch2/depth4.jpg}} \\
Interposition & When one object overlaps another object, we view it as closer. & At right, because the blue star covers the pink bar, it is seen as closer than the yellow moon. & \pandocbounded{\includegraphics[keepaspectratio,alt={A simple illustration of a blue star overlapping a pink bar and a yellow moon, demonstrating that the overlapping object appears closer.}]{images/ch2/depth5.jpg}} \\
Aerial perspective & Objects that appear hazy, or that are covered with smog or dust, appear farther away. & The artist who painted the picture on the right used aerial perspective to make the clouds more hazy and this appear farther away. & \pandocbounded{\includegraphics[keepaspectratio,alt={A painting in which distant clouds and landscape appear hazy and indistinct compared to closer elements, illustrating aerial perspective.}]{images/ch2/depth6.jpg}} \\
\end{longtable}
...
\bottomrule\noalign{}
\endlastfoot
Figure and ground & We structure input so that we always see a figure (image) against a ground (background). & At right, you may see a vase or you may see two faces, but in either case, you will organize the image as a figure against a ground. & \pandocbounded{\includegraphics[keepaspectratio,alt={A black and white image that can be perceived either as a white vase centered on a black background, or as two black faces in profile facing each other on a white background.}]{images/ch2/gestalt1.jpg}} \\
Similarity & Stimuli that are similar to each other tend to be grouped together. & You are more likely to see three similar columns among the XYX characters at right than you are to see four rows. & \pandocbounded{\includegraphics[keepaspectratio,alt={A grid of X and Y characters arranged so that similar characters form vertical columns, illustrating how similarity causes us to group like elements together.}]{images/ch2/gestalt2.jpg}} \\
Proximity & We tend to group nearby figures together. & Do you see four or eight images at right? Principles of proximity suggest that you might see only four. & \pandocbounded{\includegraphics[keepaspectratio,alt={Eight ovals arranged in four closely spaced pairs, illustrating how proximity causes nearby elements to be perceived as grouped together.}]{images/ch2/gestalt3.jpg}} \\
...
Closure & We tend to fill in gaps in an incomplete image to create a complete, whole object. & Closure leads us to see a single spherical object at right rather than a set of unrelated cones. & \pandocbounded{\includegraphics[keepaspectratio,alt={A circle made of outward-pointing cone shapes with gaps between them. Despite the gaps, the shape is perceived as a complete sphere, illustrating the principle of closure.}]{images/ch2/gestalt5.jpg}} \\
\end{longtable}
...
\begin{center}\includegraphics[width=1\linewidth,alt={Photograph of an old wooden desk covered with papers, stamps, and glasses, suggesting a workspace.}]{images/ch4/fig0} \end{center}
...
{\centering \includegraphics[width=0.6\linewidth,alt={Flowchart of Atkinson and Shiffrin's modal model of memory. Sensory memory feeds into short-term memory via attention, and short-term memory connects to long-term memory via encoding. Retrieval brings information back from long-term memory to short-term memory. A rehearsal loop cycles within short-term memory.}]{images/ch4/fig1} 
...
{\centering \includegraphics[width=0.8\linewidth,alt={Two chessboards side by side. The left shows a realistic mid-game arrangement of pieces as it might occur in actual play. The right shows the same pieces placed randomly, without any pattern reflecting real gameplay.}]{images/ch4/chess} 
...
{\centering \includegraphics[width=0.6\linewidth,alt={Diagram of Baddeley's original multicomponent model of working memory. A central executive in the center connects via bidirectional arrows to two systems: the visuospatial sketchpad on the left and the phonological loop on the right.}]{images/ch4/fig2} 
...
{\centering \includegraphics[width=0.1\linewidth,alt={A block letter F with a star marking the bottom-left corner and an arrow pointing upward.}]{images/ch4/fig3} 
...
{\centering \includegraphics[width=0.5\linewidth,alt={Diagram of Baddeley's updated multicomponent model of working memory including the episodic buffer. The central executive sits at the top, connected by bidirectional arrows to three subsystems: the visuospatial sketchpad, the episodic buffer, and the phonological loop. Below, a long-term memory band connects via bidirectional arrows to visual semantics, episodic LTM, and language, with arrows also running between those three components.}]{images/ch4/episodic} 
...
\item
  Understand how concepts are organized in semantic networks.
\item
  Learn how prior knowledge and expertise change the way we process information.
\item
  Understand how people use mental models to reason about other minds.
\end{enumerate}
...
\section{Prior Knowledge and Thinking}\label{prior-knowledge-and-thinking}
...
\subsection*{The Power of Prior Knowledge}\label{the-power-of-prior-knowledge}
...
A classic demonstration of this effect comes from Bransford \& Johnson (\citeproc{ref-bransford1972contextual}{1972}). They had people listen to passages that were difficult to understand without the right context. Read the following paragraph:

\begin{quote}
The procedure is actually quite simple. First you arrange things into different groups. Of course, one pile may be sufficient depending on how much there is to do. If you have to go somewhere else due to lack of facilities that is the next step, otherwise you are pretty well set. It is important not to overdo things. That is, it is better to do too few things at once than too many. In the short run this may not seem important but complications can easily arise. A mistake can be expensive as well. At first the whole procedure will seem complicated. Soon, however, it will become just another facet of life. It is difficult to foresee any end to the necessity for this task in the immediate future, but then one never can tell. After the procedure is completed one arranges the materials into different groups again. Then they can be put into their appropriate places. Eventually they will be used once more and the whole cycle will then have to be repeated. However, that is part of life. (\citeproc{ref-bransford1972contextual}{Bransford \& Johnson, 1972, p. 722})
\end{quote}
...
\section{Social Knowledge}\label{social-knowledge}
...
\subsection*{Understanding Other Minds}\label{understanding-other-minds}


\hyperref[theory-of-mind]{Theory of Mind} is the knowledge that others' beliefs, desires, intentions, emotions, and thoughts (i.e., their mental states) may be different from one's own, and that people's behavior is based on their mental states (\citeproc{ref-Apperly2009DoHH}{Apperly \& Butterfill, 2009}). This capacity allows you to construct mental models that explain why people act as they do and predict what they'll do next. The capacity to understand the minds of others begins to develop in the first year of life and becomes more robust throughout childhood and into adulthood.

Imagine observing someone behind a counter accepting a thin plastic object from another person. Without theory of mind, this event would be incomprehensible. With it, you immediately understand: a customer is paying a cashier with a credit card (\citeproc{ref-baird2001making}{Baird \& Baldwin, 2001}). This capacity to interpret behavior in terms of mental states is fundamental to human social life. Without it, there would be no complex social interactions, no teaching and learning, no collaboration (\citeproc{ref-tomasello2003key}{Tomasello, 2003}).

\subsection*{The Development of Theory of Mind}\label{the-development-of-theory-of-mind}
...
Infants can tell the difference between agents that act on their own and other objects (\citeproc{ref-johnson2000}{S. C. Johnson, 2000}; \citeproc{ref-premack1990}{Premack, 1990}), expect other people's actions to be directed by goals (\citeproc{ref-gergely2003teleological}{Gergely \& Csibra, 2003}; \citeproc{ref-jara-ettinger2016naive}{Jara-Ettinger et al., 2016}), and begin to assess intentionality (\citeproc{ref-malle1997folk}{Malle \& Knobe, 1997}). As we develop, we add more sophisticated abilities: we automatically imitate and synchronize with others (\citeproc{ref-chartrand1999chameleon}{Chartrand \& Bargh, 1999}; \citeproc{ref-meltzoff2003imitation}{Meltzoff \& Decety, 2003}), we engage in joint attention (sharing focus on the same object), we take others' visual perspectives, and eventually we can simulate what it's like to be in another person's position.

However, perspective-taking is difficult. People often engage in social projection, that is, assuming others think, feel, or perceive the same things they do (\citeproc{ref-krueger2007social}{Krueger, 2007}; \citeproc{ref-meltzoff2007like}{Meltzoff, 2007}). Have you ever been surprised that a friend missed the ``obvious'' point of a movie? Or worried everyone would notice the pimple on your forehead? In these situations, people find it difficult to suppress their own knowledge and overestimate the likelihood that other people will share their perspective (\citeproc{ref-keysar1994illusory}{Keysar, 1994}), and how attentive other people will be to the things they are focused on (\citeproc{ref-gilovich1999spotlight}{Gilovich \& Savitsky, 1999}).

\subsubsection*{The False Belief Test}\label{the-false-belief-test}


A key milestone in theory of mind development is passing the false-belief test (\citeproc{ref-wimmer1983beliefs}{Wimmer \& Perner, 1983}). In this test, children see a story: Sally puts her ball in a basket and leaves the room. While Sally is gone, Anne moves the ball from the basket to a box. Children are asked where Sally will look for the ball when she returns.

The correct answer is the basket: that's where Sally believes it is. But children must infer this false belief against their own knowledge that the ball is actually in the box. This is very difficult for children before age 4, and it takes cognitive effort even for adults (\citeproc{ref-epley2004perspective}{Epley et al., 2004}).

\paragraph*{Infant Social Cognition}\label{infant-social-cognition}
\addcontentsline{toc}{paragraph}{Infant Social Cognition}
...
Infants use observations of people's goal directed actions to infer mental states and predict future behavior (\citeproc{ref-GERGELY1995165}{Gergely et al., 1995}; \citeproc{ref-jara-ettinger2016naive}{Jara-Ettinger et al., 2016}; \citeproc{ref-woodward1998}{Woodward, 1998}). For example, infants watch how much effort or risk someone is willing to take to get different objects. If an agent works harder or take bigger risks to obtain one toy over another, infants infer that the agent prefers the harder-to-get toy (\citeproc{ref-liu2017ten}{Liu et al., 2017}, \citeproc{ref-liu2022dangerous}{2022}). In other words, infants appear to use the ``cost'' someone pays (in effort or risk) to figure out how much that person values different goals.

Infants also use social interactions to infer relationships between people (\citeproc{ref-powell2022adopted}{Powell, 2022}). Recent research shows that infants expect people who imitate each other to have closer relationships, and expect that imitators will be more likely to help and comfort those they imitate (\citeproc{ref-kudrnova2024infants}{Kudrnova et al., 2024}; \citeproc{ref-pepe2023infants}{Pepe \& Powell, 2023}). Infants also use other social cues to infer relationship strength. For example, in a study by A. J. Thomas et al. (\citeproc{ref-thomas2022early}{2022}), infants saw one social agent share saliva with a second agent, and also pass a ball back-and-forth with a third agent. Infants expected the saliva-sharer to have a stronger relationship with their partner and to be more likely to comfort them when distressed.
...
\item
  Reflection: Think of something you're an ``expert'' in---this could be a hobby, sport, academic subject, video game, TV show, or anything else you know well. How does your knowledge change the way you notice things or understand new information in that domain? Can you give an example of a pattern or connection you see that a novice wouldn't notice?
\item
  Application: Think of a time when you misunderstood someone's behavior because you didn't consider their different knowledge or perspective. What went wrong? How does this relate to the false belief test and the problem of egocentrism in theory of mind?
\end{enumerate}
...
\bibitem[\citeproctext]{ref-bransford1972contextual}
Bransford, J. D., \& Johnson, M. K. (1972). Contextual prerequisites for understanding: Some investigations of comprehension and recall. \emph{Journal of Verbal Learning and Verbal Behavior}, \emph{11}(6), 717--726.
...
\emph{State v. guilbert} (Vol. 306, p. 705). (2012). Connecticut Supreme Court.
...
\emph{United states v. greene} (Vol. 704, p. 298). (2013). United States Court of Appeals, Fourth Circuit.
