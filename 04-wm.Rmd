...
```{r fig4.1, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Figure 1. Atkinson and Shiffrin’s Modal Model of Memory. Image from Wikimedia Commons.'}
...
```{r fig4.2, echo = FALSE, out.width='60%', fig.align = 'center'}
...
```{r fig4.3, echo = FALSE, out.width='10%', fig.align = 'center'}
