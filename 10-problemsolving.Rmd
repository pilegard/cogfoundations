...
```{r ninedot, echo = FALSE, out.width='35%', fig.align = 'center', fig.cap = 'The nine-dot problem.', fig.alt = 'Nine dots arranged in a 3 by 3 grid with equal spacing, used to illustrate the nine-dot problem.'}
