# Knowledge
```{r fig7.1, echo = FALSE, out.width='100%', fig.align = 'center'}
 knitr::include_graphics("images/ch7/fig1.png")
```
...
```{r fig7.2, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Although you’ve (probably) never seen this particular truck before, you know a lot about it because of the knowledge you’ve accumulated in the past about the features in the category of trucks. [Image: CC0 Public Domain, https://goo.gl/m25gce]'}
...
```{r fig7.3, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Although you’ve (probably) never seen this particular truck before, you know a lot about it because of the knowledge you’ve accumulated in the past about the features in the category of trucks. [Image: CC0 Public Domain, https://goo.gl/m25gce]'}
...
```{r fig7.4, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'When you think of “bird,” how closely does the robin resemble your general figure? [Image: CC0 Public Domain, https://goo.gl/m25gce]'}
...
```{r fig7.6, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Figure 5. Semantic Network according to Collins and Quillian with nodes, links, concept names and properties. '}
