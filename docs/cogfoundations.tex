...
\caption{Book cover image with the title ``Cognitive Foundations,'' with ``Second Edition'' and ``Edited by Celeste Pilegard'' in smaller text. The background shows an unlit incandescent lightbulb against a bright pink and green background.}
\end{figure}
...
\textbf{Note for screen reader users:} The HTML version of this book is the fully accessible version. The PDF version does not support alt text or other accessibility features. To access the HTML version, visit \href{https://pilegard.github.io/cogfoundations/}{pilegard.github.io/cogfoundations/}.
