...
```{r fig9.2, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Original Wason Selection Task cards'}
knitr::include_graphics("images/ch9/fig2.png")
```

```{r fig9.3, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Drinking-age Wason Selection Task'}
...
```{r fig9.7, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'a) value weighting function and b) probability weighting function, both from Prospect Theory. v(.) refers to subjective utility, and w(.) refers to subjective probability.'}
