...
```{r mcgurk, echo = FALSE, out.width='25%', fig.align = 'center', fig.cap ="Watch The McGurk Effect [YouTube]: http://www.youtube.com/watch?v=jtsfidRq2tw "}
...
```{r humanfactors, echo = FALSE, out.width='90%', fig.align = 'center', fig.cap = 'Airplane instrument panel before and after it was redesigned by human factors psychologists.'}
