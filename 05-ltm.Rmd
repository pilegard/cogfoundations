...
```{r fig1, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Figure 1. The serial position curve is the result of both primacy effects and recency effects.'}
#knitr::include_graphics("images/ch5/fig1.jpeg")
```
