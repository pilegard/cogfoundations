...
```{r lop, echo = FALSE, out.width='40%', fig.align = 'center', fig.cap = 'Levels of processing based on evidence from Craik and Tulving.'}
...
```{r albumbs, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Photo albums can be great sources of retrieval cues. Photo by BBH Singapore on Uplash.'}
...
```{r morris, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Results from Morris and colleagues’ Transfer-Appropriate Processing experiment.'}
