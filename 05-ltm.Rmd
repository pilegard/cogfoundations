...
```{r intro, echo = FALSE, out.width='100%', fig.align = 'center'}
...
```{r fig1, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'The serial position curve is the result of both primacy effects and recency effects.'}
...
```{r fig2, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Types of long-term memory.'}
...
```{r fig3, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Research Results. @Bargh1996 found that priming words associated with the ederly made people walk more slowly.'}
#knitr::include_graphics("images/ch5/fig3.jpg")
```
...
```{r fig4, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Photo by Robert Bye on Uplash.'}
#knitr::include_graphics("images/ch5/fig4.jpg")
```
...
```{r fig5, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Levels of processing based on evidence from Craik & Tulving. Rogers and colleagues would later add an even deeper level - self-reference.'}
#knitr::include_graphics("images/ch5/fig5.jpg")
```
...
```{r fig6, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Levels of processing based on evidence from Craik & Tulving. Rogers and colleagues would later add an even deeper level - self-reference.'}
#knitr::include_graphics("images/ch5/fig6.jpg")
```
...
```{r fig7, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Photo albums can be great sources of retireval cues. Photo by BBH Singapore on Unsplash.'}
#knitr::include_graphics("images/ch5/fig7.jpg")
```
