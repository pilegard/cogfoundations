...
```{r penguins, echo = FALSE, out.width='100%', fig.align = 'center'}
 knitr::include_graphics("images/ch7/cover-penguins.png")
```
...
```{r truck, echo = FALSE, out.width='50%', fig.align = 'center', fig.cap = 'Although you’ve (probably) never seen this particular truck before, you know a lot about it because of the knowledge you’ve accumulated in the past about the features in the category of trucks. [Image: CC0 Public Domain, https://goo.gl/m25gce]'}
...
```{r table1, echo = FALSE, out.width='30%', fig.align = 'center', fig.cap = 'Examples of two categories, with members ordered by typicality (from Rosch and Mervis, 1975)'}
...
```{r textbox1, echo = FALSE, out.width='80%', fig.align = 'center', fig.cap = 'Influences of typicality on cognition.'}
...
```{r bird, echo = FALSE, out.width='40%', fig.align = 'center', fig.cap = 'When you think of “bird,” how closely does the robin resemble your general figure? [Image: CC0 Public Domain, https://goo.gl/m25gce]'}
