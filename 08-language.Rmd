...
```{r fig1, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Figure 1. Figure 1 Drawing of Brain Showing Broca’s and Wernicke’s Areas.'}
knitr::include_graphics("images/ch8/fig1.jpg")
```
...
```{r fig2, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Figure 2. Practicing Language. Babies often engage in vocal exchanges to help them practice language.'}
...
```{r fig3, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Figure 3. English Proficiency in Native Chinese Speakers. Hakuta, Bialystok, and Wiley (2003) found no evidence for critical periods in language learning. Regardless of level of education, self-reported second-language skills decreased consistently across age of immigration.'}
...
#knitr::include_graphics("images/ch8/qr.jpg")
```
