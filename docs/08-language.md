...
{\centering \includegraphics[width=0.25\linewidth]{images/ch8/qr} \includegraphics[width=0.25\linewidth]{images/ch8/kanzi} 

}

\caption{[Watch: “Kanzi and Novel Sentences” on YouTube](http://www.youtube.com/watch?v=2Dhc2zePJFE); Image: [Wikimedia Commons](https://upload.wikimedia.org/wikipedia/commons/2/29/Bonobo_Kanzi_postshower_2005-07-23_GATI_330crop_%282014_11_14_01_04_18_UTC%29.jpg)}(\#fig:kanzi)
\end{figure}
...
\caption{A model of communication with language exchanges to help them practice language.}(\#fig:model)
\end{figure}
...
People who study second language acquisition in adults tend to focus narrowly on grammar, especially on acquiring phonetics, morphology and syntax. This grammar-focused approach to teaching and learning often treats language as something that can acquired in isolation from people, communities, and relationships, and has roots in colonial ways of thinking [@czaykowska2017;@lukaniec2022;@mackenzie2022]. However, adult language learners bring all kinds of cultural knowledge, traditions, expectations, and emotions to language learning, which we may or may not be consciously aware of.
