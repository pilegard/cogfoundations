...
```{r kanzi, echo = FALSE, out.width='75%', fig.align = 'center', fig.cap = 'Sue Savage-Rumbaugh (L), Kanzi (R), and his sister Panbinisha (C) working together in 2006. To see Kanzi in action, watch [“Kanzi and Novel Sentences” on YouTube](http://www.youtube.com/watch?v=2Dhc2zePJFE). Image by William H. Calvin, CC BY-SA 4.0'}
...
```{r model, echo = FALSE, out.width='80%', fig.align = 'center', fig.cap = 'A model of communication with language exchange.'}
