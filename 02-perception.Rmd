...
```{r humanfactors, echo = FALSE, out.width='80%', fig.align = 'center', fig.cap = 'Airplane instrument panel before and after it was redesigned by human factors psychologists.'}
