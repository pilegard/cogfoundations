...
All images in the HTML version of this textbook include alternative text (alt text) for compatibility with screen readers and other assistive technologies. The PDF version does not support alt text or other accessibility features. To access the HTML version, visit \href{https://pilegard.github.io/cogfoundations/}{pilegard.github.io/cogfoundations/}.
