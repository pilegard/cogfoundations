...
```{r induct, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'An example of inductive reasoning would be generalizing from the subset of crows you have seen to all crows.'}
