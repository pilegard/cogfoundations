...
\caption{The simplest version of Atkinson and Shiffrin’s Modal Model of Memory.}(\#fig:modalmodel)
\end{figure}
...
\caption{The original multicomponent working memory model from @BADDELEY197447.}(\#fig:baddeley)
\end{figure}
...
\caption{The block letter F task.}(\#fig:blockf)
\end{figure}
...
\caption{An updated version of the multicomponent working memory model [@Baddeley2000].}(\#fig:episodic)
\end{figure}
