...
```{r serialposition, echo = FALSE, out.width='95%', fig.align = 'center', fig.cap = 'The serial position curve is the result of both primacy effects and recency effects.'}
knitr::include_graphics("images/ch5/fig1.png")
```
