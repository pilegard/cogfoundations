...
```{r table1, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Table 1. Examples of two categories, with members ordered by typicality (from Rosch and Mervis, 1975)'}
...
```{r fig7.6, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Semantic Network according to Collins and Quillian with nodes, links, concept names and properties. '}
