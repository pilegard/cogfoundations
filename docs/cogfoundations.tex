...
\caption{Figure 1. Atkinson and Shiffrin’s Modal Model of Memory. Image from Wikimedia Commons.}(\#fig:fig4.1)
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{images/ch5/fig1} 

}

\caption{The serial position curve is the result of both primacy effects and recency effects.}(\#fig:fig5.1)
\end{figure}

The distinction between working memory and long-term memory can be demonstrated with the \protect\hyperlink{serial-position-curve}{serial position curve}. When we give people a long list of words one at a time (e.g., on flashcards) and then ask them to recall them, the results look something like those in @ref(fig:fig5.1). People are able to retrieve more words that were presented to them at the beginning and the end of the list than they are words that were presented in the middle of the list. This pattern, known as the serial position curve, is caused by two retrieval phenomenon: The \protect\hyperlink{primacy-effect}{primacy effect} refers to \emph{a tendency to better remember stimuli that are presented early in a list}. The \protect\hyperlink{recency-effect}{recency effect} refers to \emph{the tendency to better remember stimuli that are presented later in a list}.
...
{\centering \includegraphics[width=0.6\linewidth]{images/ch5/fig2} 

}

\caption{Types of long-term memory.}(\#fig:fig5.2)
\end{figure}
...
\caption{Photo by Robert Bye on Uplash.}(\#fig:fig5.3)
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{images/ch5/fig4} 

}

\caption{Levels of processing based on evidence from Craik and Tulving.}(\#fig:fig5.4)
\end{figure}
...
\caption{Photo albums can be great sources of retrieval cues. Photo by BBH Singapore on Uplash.}(\#fig:fig5.5)
\end{figure}
...
\caption{Results from Morris and colleagues` Transfer-Apprpriate Processing experiment.}(\#fig:fig5.6)
\end{figure}
...
\caption{Misinformation can be introduced into the memory of a witness between the time of seeing an event and reporting it later. Something as straightforward as which sort of traffic sign was in place at an intersection can be confused if subjects are exposed to erroneous information after the initial incident.}(\#fig:fig6.2)
\end{figure}
...
\addcontentsline{toc}{paragraph}{Identifying Perpetrators}
...
\caption{Can you tell which coin, (a), (b), (c), or (d) is the accurate depiction of a US nickel? The correct answer is (c).}(\#fig:fig6.3)
\end{figure}
...
\begin{center}\includegraphics[width=1\linewidth]{images/ch7/fig1} \end{center}
...
{\centering \includegraphics[width=0.6\linewidth]{images/ch7/fig1} 

}

\caption{Although you’ve (probably) never seen this particular truck before, you know a lot about it because of the knowledge you’ve accumulated in the past about the features in the category of trucks. [Image: CC0 Public Domain, https://goo.gl/m25gce]}(\#fig:fig7.2)
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{images/ch7/fig2} 

}

\caption{Although you’ve (probably) never seen this particular truck before, you know a lot about it because of the knowledge you’ve accumulated in the past about the features in the category of trucks. [Image: CC0 Public Domain, https://goo.gl/m25gce]}(\#fig:fig7.3)
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{images/ch7/table1} 

}

\caption{Table 1. Examples of two categories, with members ordered by typicality (from Rosch and Mervis, 1975)}\label{fig:table1}
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{images/ch7/textbox1} 

}

\caption{Text Box 1.}\label{fig:textbox1}
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{images/ch7/fig3} 

}

\caption{When you think of “bird,” how closely does the robin resemble your general figure? [Image: CC0 Public Domain, https://goo.gl/m25gce]}(\#fig:fig7.4)
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{images/ch7/fig4} 

}

\caption{If you were asked, “What kind of animal is this?” according to prototype theory, you would consult your summary representations of different categories and then select the one that is most similar to this image—probably a lizard! [Image: Adhi Rachdian, https://goo.gl/dQyUwf, CC BY 2.0, https://goo.gl/BRvSA7]}(\#fig:fig7.5)
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{images/ch8/qr} 

}

\caption{ HYPERLINK "http://www.youtube.com/watch?v=2Dhc2zePJFE"Watch: “Kanzi and Novel Sentences” [YouTube]: http://www.youtube.com/watch?v=2Dhc2zePJFE}\label{fig:qr}
\end{figure}
...
\caption{A model of communication with language exchanges to help them practice language.}(\#fig:fig8.2)
\end{figure}
...
{[}\includegraphics{"images/ch8/tuning_into_speech_sounds.png"}(\url{https://www.youtube.com/watch?v=WvM5bqUsbu8}){]}
...
{\centering \includegraphics[width=0.6\linewidth]{images/ch8/fig2} 

}

\caption{Practicing Language. Babies often engage in vocal exchanges to help them practice language.}(\#fig:fig8.3)
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{images/ch8/fig3} 

}

\caption{English Proficiency in Native Chinese Speakers. Hakuta, Bialystok, and Wiley (2003) found no evidence for critical periods in language learning. Regardless of level of education, self-reported second-language skills decreased consistently across age of immigration.}(\#fig:fig8.4)
\end{figure}
...
\leavevmode\vadjust pre{\hypertarget{ref-national2003eyewitness}{}}%
