...
<div class="figure" style="text-align: center">
<img src="images/ch2/fig8.png" alt="Airplane instrument panel before (left) and after (right) it was redesigned by human factors psychologists." width="80%" />
<p class="caption">(\#fig:humanfactors)Airplane instrument panel before (left) and after (right) it was redesigned by human factors psychologists.</p>
</div>
:::
