...
```{r fig5.0, echo = FALSE, out.width='100%', fig.align = 'center'}
 knitr::include_graphics("images/ch5/fig0.png")
```
...
```{r fig5.1, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'The serial position curve is the result of both primacy effects and recency effects.'}
knitr::include_graphics("images/ch5/fig1.jpg")
```
...
```{r fig5.2, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Types of long-term memory.'}
knitr::include_graphics("images/ch5/fig2.jpg")
```
...
```{r fig5.3, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Photo by Robert Bye on Uplash.'}
...
```{r fig5.4, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Levels of processing based on evidence from Craik & Tulving. Rogers and colleagues would later add an even deeper level - self-reference.'}
...
```{r fig5.5, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Photo albums can be great sources of retrieval cues. Photo by BBH Singapore on Uplash.'}
knitr::include_graphics("images/ch5/fig5.png")
```
...
```{r fig5.6, echo = FALSE, out.width='60%', fig.align = 'center', fig.cap = 'Results from Morris and colleagues` Transfer-Apprpriate Processing experiment.'}
knitr::include_graphics("images/ch5/fig6.png")
```
