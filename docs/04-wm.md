...
<img src="images/ch4/fig1.png" alt="The simplest version of Atkinson and Shiffrin’s Modal Model of Memory." width="60%" />
<p class="caption">(\#fig:modalmodel)The simplest version of Atkinson and Shiffrin’s Modal Model of Memory.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/ch4/fig2.png" alt="The original multicomponent working memory model from @BADDELEY197447." width="60%" />
<p class="caption">(\#fig:baddeley)The original multicomponent working memory model from @BADDELEY197447.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/ch4/fig3.png" alt="The block letter F task." width="10%" />
<p class="caption">(\#fig:blockf)The block letter F task.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/ch4/episodic.png" alt="An updated version of the multicomponent working memory model [@Baddeley2000]." width="50%" />
<p class="caption">(\#fig:episodic)An updated version of the multicomponent working memory model [@Baddeley2000].</p>
</div>
